          ...
          {i18n.resolvedLanguage === "fr" ? (
            <>
              <section>
                ...
                <p>
                  PrepIQ ("nous" ou "notre") s'engage à protéger votre vie
                  privée. Cette politique explique comment nous collectons,
              ...
              <section>
                ...
                <ul className="list-disc pl-5 space-y-1.5">
                  <li>
                    <strong className="text-foreground">Compte :</strong> Nom,
                    email, entreprise lors de l'inscription.
                  </li>
                  <li>
                    <strong className="text-foreground">
                      Données opérationnelles :
                    </strong>{" "}
                    Ventes, inventaire et données de cuisine téléchargées.
                  </li>
                  <li>
                    <strong className="text-foreground">Usage :</strong>{" "}
                    Interactions avec le Service et durée des sessions.
                  </li>
                  <li>
                    <strong className="text-foreground">Appareil :</strong>{" "}
                    Navigateur, OS et adresse IP.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  Nous ne vendons pas vos données. Nous les partageons
                  uniquement avec nos prestataires de confiance pour le
                  fonctionnement du Service ou par obligation légale.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Nous utilisons des mesures standards (chiffrement TLS 1.3 et
                  AES-256) pour protéger vos données. Notre infrastructure est
                  conforme aux normes SOC 2.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  En cas de suppression, vos données personnelles sont effacées
                  sous 30 jours.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Nous utilisons des cookies essentiels au fonctionnement et des
              ...
              <section>
                ...
                <p>
                  Vos données peuvent être traitées dans des pays tiers avec des
              ...
              <section>
                ...
                <p>
                  Nous pouvons mettre à jour cette politique. La date de mise à
                  jour sera modifiée en conséquence.
                </p>
              </section>
            </>
          ) : (
            <>
              <section>
                ...
                <p>
                  PrepIQ ("we," "our," or "us") is committed to protecting your
                  privacy. This Privacy Policy explains how we collect, use,
                  disclose, and safeguard your information when you use our
                  platform and services. Please read this policy carefully. By
                  using the Service, you consent to the practices described
                  herein.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-5 space-y-1.5">
                  ...
                  <li>
                    Generate demand forecasts, prep plans, and operational
                    recommendations
                  </li>
              ...
              <section>
                ...
                <ul className="list-disc pl-5 space-y-1.5">
                  <li>
                    ...
                    Trusted third parties that help us operate the Service
              ...
              <section>
                ...
                <p>
                  ...
                  your data, including encryption in transit (TLS 1.3) and at
                  rest (AES-256), regular security audits, and access controls.
                  Our infrastructure is SOC 2 compliant. However, no method of
              ...
              <section>
                ...
                <p>
                  ...
                  deletion, we will remove your personal data within 30 days,
                  except where retention is required by law. Anonymized,
              ...
              <section>
                ...
                <p className="mt-3">
                  ...
                  <a
                    href="mailto:privacy@prepiq.com"
              ...
              <section>
                ...
                <p>
                  We use essential cookies to operate the Service and optional
