  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="section-container py-16 md:py-24 max-w-3xl">
        <h1 className="text-3xl md:text-4xl font-semibold text-foreground mb-2">{t("privacy.title")}</h1>
          ...
          {i18n.resolvedLanguage === 'fr' ? (
            <>
              <section>
                ...
                <p>
                  PrepIQ ("nous" ou "notre") s'engage à protéger votre vie privée. Cette politique explique comment nous collectons, utilisons et protégeons vos informations.
                </p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">2. Informations collectées</h2>
                <ul className="list-disc pl-5 space-y-1.5">
                  <li><strong className="text-foreground">Compte :</strong> Nom, email, entreprise lors de l'inscription.</li>
                  <li><strong className="text-foreground">Données opérationnelles :</strong> Ventes, inventaire et données de cuisine téléchargées.</li>
                  <li><strong className="text-foreground">Usage :</strong> Interactions avec le Service et durée des sessions.</li>
                  <li><strong className="text-foreground">Appareil :</strong> Navigateur, OS et adresse IP.</li>
                </ul>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">3. Utilisation des informations</h2>
                <ul className="list-disc pl-5 space-y-1.5">
                  <li>Fournir et améliorer le Service.</li>
                  <li>Générer des prévisions et des plans de mise en place.</li>
                  <li>Gérer votre abonnement et les transactions.</li>
                  <li>Assurer le support client et la sécurité.</li>
                </ul>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">4. Partage des données</h2>
                <p>Nous ne vendons pas vos données. Nous les partageons uniquement avec nos prestataires de confiance pour le fonctionnement du Service ou par obligation légale.</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">5. Sécurité</h2>
                <p>Nous utilisons des mesures standards (chiffrement TLS 1.3 et AES-256) pour protéger vos données. Notre infrastructure est conforme aux normes SOC 2.</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">6. Conservation</h2>
                <p>Nous conservons vos données tant que votre compte est actif. En cas de suppression, vos données personnelles sont effacées sous 30 jours.</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">7. Vos droits</h2>
                <p>Vous disposez d'un droit d'accès, de rectification et de suppression de vos données. Contactez-nous à privacy@prepiq.com.</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">8. Cookies</h2>
                <p>Nous utilisons des cookies essentiels au fonctionnement et des cookies analytiques optionnels.</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">9. Transferts internationaux</h2>
                <p>Vos données peuvent être traitées dans des pays tiers avec des garanties appropriées (Clauses Contractuelles Types).</p>
              </section>

              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">10. Modifications</h2>
                <p>Nous pouvons mettre à jour cette politique. La date de mise à jour sera modifiée en conséquence.</p>
              </section>
            </>
          ) : (
            <>
